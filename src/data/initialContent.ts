...
export const INITIAL_CHARACTERS: Character[] = [
  {
    ...
    dialogueTree: {
      'rahul-intro-1': {
        id: 'rahul-intro-1',
        speaker: 'Rahul',
        text: "Oh, hello there! I heard that City Hall finally hired a digital accessibility architect.",
        nextId: 'rahul-intro-2',
      },
      'rahul-intro-2': {
        id: 'rahul-intro-2',
        speaker: 'Player',
        text: "Hi Rahul! Nice to meet you. Yes, I'm Ava. I'm here to audit our digital systems.",
        nextId: 'rahul-intro-3',
      },
      'rahul-intro-3': {
        id: 'rahul-intro-3',
        speaker: 'Rahul',
        text: "Audits are long overdue. As a blind screen reader user, trying to navigate our healthcare portal is an exercise in frustration.",
        nextId: 'rahul-intro-4',
      },
      'rahul-intro-4': {
        id: 'rahul-intro-4',
        speaker: 'Rahul',
        text: "For instance, their booking page has three main buttons. But my screen reader only reads 'button, button, button' because they have no text labels. I have to guess which is which!",
        nextId: 'rahul-intro-5',
      },
      'rahul-intro-5': {
        id: 'rahul-intro-5',
        speaker: 'Rahul',
        text: "Imagine navigating a city where all signposts are completely blank. Could you help us add clear, descriptive text labels to these fields?",
  ...
  },
  {
    ...
    dialogueTree: {
      'fatima-intro-1': {
        id: 'fatima-intro-1',
        speaker: 'Fatima',
        text: "Hi! You must be Ava, the new digital product designer. I'm Fatima.",
        nextId: 'fatima-intro-2',
      },
      'fatima-intro-2': {
        id: 'fatima-intro-2',
        speaker: 'Player',
        text: "Hi Fatima! Yes, that's me. How are things going with the city transit system?",
        nextId: 'fatima-intro-3',
      },
      'fatima-intro-3': {
        id: 'fatima-intro-3',
        speaker: 'Fatima',
        text: "To be honest, the digital transit portal has been quite difficult. I'm deaf, and the video guide they posted has mumble-level audio and zero subtitles.",
        nextId: 'fatima-intro-4',
      },
      'fatima-intro-4': {
        id: 'fatima-intro-4',
        speaker: 'Fatima',
        text: "I literally cannot understand a single instruction on how to purchase a monthly travel card. All audio content needs equivalent visual alternatives.",
        nextId: 'fatima-intro-5',
      },
      'fatima-intro-5': {
        id: 'fatima-intro-5',
        speaker: 'Fatima',
        text: "Could you help us fix the video player so that it displays synchronized captions and clear textual guidance?",
  ...
  },
  {
    ...
    dialogueTree: {
      'grandma-intro-1': {
        ...
        text: "Oh, hello sweetie! You must be Ava. I saw you looking around our beautiful plaza.",
        nextId: 'grandma-intro-2',
      },
      'grandma-intro-2': {
        id: 'grandma-intro-2',
        speaker: 'Player',
        text: "Hello Grandma Mira! Yes, I'm here auditing our digital services. Is there something I can help with?",
        nextId: 'grandma-intro-3',
      },
      'grandma-intro-3': {
        id: 'grandma-intro-3',
        speaker: 'Grandma Mira',
        text: "Well, the scheduling calendar on the pharmacy site is very hard for my eyes. The available dates are marked only in light green circles, and the full ones in gray.",
        nextId: 'grandma-intro-4',
      },
      'grandma-intro-4': {
        id: 'grandma-intro-4',
        speaker: 'Grandma Mira',
        text: "Because of my color vision deficiency, green and gray look almost identical. Plus, the buttons are so small my arthritic fingers keep clicking the wrong dates!",
        nextId: 'grandma-intro-5',
      },
      'grandma-intro-5': {
        id: 'grandma-intro-5',
        speaker: 'Grandma Mira',
        text: "We need dates to have distinct text labels or icons like checkmarks, not just color, and larger touch targets. Can you help redesign it?",
  ...
  },
  {
    ...
    dialogueTree: {
      'kofi-intro-1': {
        id: 'kofi-intro-1',
        speaker: 'Kofi',
        text: "Hey there, Ava! I'm Kofi. I heard you're doing an audit of the Design Lab portal today.",
        nextId: 'kofi-intro-2',
      },
      'kofi-intro-2': {
        id: 'kofi-intro-2',
        speaker: 'Player',
        text: "Hey Kofi! That's correct. I want to make sure it is fully operable for everyone in the department.",
        nextId: 'kofi-intro-3',
      },
      'kofi-intro-3': {
        id: 'kofi-intro-3',
        speaker: 'Kofi',
        text: "That's awesome. Right now, it's completely unusable for me. I can't use a mouse, so I navigate websites entirely by pressing the Tab key.",
        nextId: 'kofi-intro-4',
      },
      'kofi-intro-4': {
        id: 'kofi-intro-4',
        speaker: 'Kofi',
        text: "But the lab portal doesn't show any visible focus outlines, and the tab focus order jumps randomly into invisible advertisement links instead of following the logical reading order.",
        nextId: 'kofi-intro-5',
      },
      'kofi-intro-5': {
        id: 'kofi-intro-5',
        speaker: 'Kofi',
        text: "I literally get lost on the page and can't find where I'm clicking. Can you help us fix the keyboard tab order and make focus outlines visible?",
  ...
  },
  {
    ...
    dialogueTree: {
      'elena-intro-1': {
        id: 'elena-intro-1',
        speaker: 'Elena',
        text: "Hello, Ava. Could I talk to you for a moment about the public library portal forms?",
        nextId: 'elena-intro-2',
      },
      'elena-intro-2': {
        id: 'elena-intro-2',
        speaker: 'Player',
        text: "Of course, Elena! What's been going on with the library registration forms?",
        nextId: 'elena-intro-3',
      },
      'elena-intro-3': {
        id: 'elena-intro-3',
        speaker: 'Elena',
        text: "They are incredibly stressful to use. There is a strict 20-second timer ticking down on the page, and the layout is full of confusing, blinking icons.",
        nextId: 'elena-intro-4',
      },
      'elena-intro-4': {
        id: 'elena-intro-4',
        speaker: 'Elena',
        text: "If I make one tiny spelling mistake, the form wipes all my typed fields completely clean and gives no error description, forcing me to start over under time pressure.",
        nextId: 'elena-intro-5',
      },
      'elena-intro-5': {
        id: 'elena-intro-5',
        speaker: 'Elena',
        text: "It spikes my anxiety and makes it hard to focus. Can we simplify this form layout, make errors clear, and let users extend timed sessions?",
  ...
  },
  {
    ...
    dialogueTree: {
      'yuki-intro-1': {
        id: 'yuki-intro-1',
        speaker: 'Yuki',
        text: "Excuse me, Ava? I just moved to Access City, and I have a quick question about the civic portal.",
        nextId: 'yuki-intro-2',
      },
      'yuki-intro-2': {
        id: 'yuki-intro-2',
        speaker: 'Player',
        text: "Welcome to the city, Yuki! Yes, how can I help you with the enrollment portal?",
        nextId: 'yuki-intro-3',
      },
      'yuki-intro-3': {
        id: 'yuki-intro-3',
        speaker: 'Yuki',
        text: "Thank you! The registration page uses extremely dense legal terminology and phrases that are very difficult for non-native speakers to understand.",
        nextId: 'yuki-intro-4',
      },
      'yuki-intro-4': {
        id: 'yuki-intro-4',
        speaker: 'Yuki',
        text: "Terms like 'indemnification' and complex idioms make it hard to know what rights I am agreeing to. We need plain-language explanations.",
        nextId: 'yuki-intro-5',
      },
      'yuki-intro-5': {
        id: 'yuki-intro-5',
        speaker: 'Yuki',
        text: "Could we provide clear, plain summaries or direct definitions for complex vocabulary so everyone can read it?",
